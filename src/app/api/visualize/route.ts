    ...
    const geminiPayload = {
      contents: [{
        parts: [
          ...
          {
            text: `אתה מעצב פנים ידידותי. הלקוח רוצה: "${description}"

כתוב תשובה קצרה וכיפית בעברית (3-4 משפטים מקסימום):
- משפט אחד על מה שרואים בתמונה
- משפט על השינוי המרכזי שיעשה הכי הרבה הבדל
- משפט מעודד על התוצאה הצפויה

אל תשתמש בסימנים מיוחדים, כוכביות או מספור. פשוט טקסט רגיל וזורם.`
          }
        ]
      }]
    };

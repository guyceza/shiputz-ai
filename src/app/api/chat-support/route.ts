...
💰 מחיר:
- Pro: ₪99 חד-פעמי (מבצע פורים: ₪69). כולל 4 הדמיות AI, הערכות עלויות, כתב כמויות, ניתוח הצעות מחיר, סריקת קבלות, מעקב תקציב, Shop the Look. אפשר לקנות חבילות נוספות.
- לכל משך הפרויקט, ללא הגבלת זמן
- לא מנוי — תשלום חד-פעמי, בלי חיוב חוזר

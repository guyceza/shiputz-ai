...
## בנוסף לכתב הכמויות, הפק דוח פעולה לקבלן:
- missingItems: סעיפים שייתכן שחסרים וצריך לוודא מול הקבלן
- contractorQuestions: שאלות מדויקות לקבלן לפני קבלת הצעה
- riskFlags: סיכונים או מקומות שבהם הכמות היא הערכה בלבד
- revisionRequest: נוסח קצר לבקשת הצעה מתוקנת ומפורטת
...
## פורמט התשובה (JSON בלבד!):
{
  ...
  "missingItems": [
    "לוודא האם פינוי פסולת, הובלות וניקיון סופי כלולים בהצעה",
    "לוודא מפרט חומרי גמר: סוג ריצוף, דבק, רובה, צבע ואביזרי חשמל"
  ],
  "contractorQuestions": [
    "האם המחיר כולל מע״מ, פינוי פסולת ואחריות?",
    "איזה מותג ורמת גמר כלולים בכל סעיף?"
  ],
  "riskFlags": [
    "סעיפי חשמל ואינסטלציה הם הערכה אם לא צורפה תכנית ייעודית",
    "כמויות ללא סקאלה מדויקת דורשות אימות שטח לפני חוזה"
  ],
  "revisionRequest": "נא להחזיר הצעה מתוקנת עם כמות, יחידה, מחיר יחידה, מותג/רמת חומר, מה כלול ומה לא כלול בכל סעיף.",

...
💰 מחיר:
- Pro: ₪29/חודש (5 הדמיות בחודש + חבילות נוספות לרכישה, הערכות עלויות, כתב כמויות, ניתוח הצעות מחיר, סריקת קבלות, מעקב תקציב, Shop the Look, ביטול בכל רגע)
- שנתי: ₪19/חודש (₪228 לשנה, חיסכון 35%)
